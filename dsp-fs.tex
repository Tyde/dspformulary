...
\subtitle{Formulary}
\subsubtitle{Author: Daniel Thiem - studium@daniel-thiem.de\\Version 0.6.7 - 15.02.2013}
...
\begin{subequations}
\begin{align}
N&=\frac{\log\left(\frac{1}{\alpha_2^2}-1\right)-\log\left(\frac{1}{(1-\alpha_1)^2}-1\right)}{2(\log\left(\Omega_S\right)-\log\left(\Omega_P\right))}\\
\Omega_c&=\sqrt[2N]{\frac{\Omega_S^{2N}}{1/\hat{\alpha}_2^2-1}}
\end{align}
