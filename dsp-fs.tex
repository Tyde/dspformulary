...
\subtitle{Formulary}
\subsubtitle{Author: Daniel Thiem - studium@daniel-thiem.de\\Version 0.6.4 - 14.02.2013}
...
\begin{subequations}
\begin{align}
N&=\frac{\log\left(\frac{1}{\alpha_2}-1\right)+\log\left(\frac{1}{1-\alpha_1}+1\right)}{2(\log\left(\Omega_S\right)-\log\left(\Omega_P\right))}\\
